    ...
    <div className="grid grid-cols-12 lg:pb-22 lg:pt-0 py-20 relative">
      ...
      <div className="lg:col-span-11 col-span-12">
        ...
        <div className="flex lg:flex-row flex-col justify-start w-full gap-6 py-5">
          <div className=" bg-white lg:w-1/3 w-full shadow-lg rounded-lg">
            {/* Image  */}
          ...
          <div className=" bg-white lg:w-1/3 w-full shadow-lg rounded-lg">
            {/* Image  */}
            <figure className="bg-[url(https://i.ibb.co/PzmZq335/pexels-scottwebb-140982.jpg)] h-[250px] w-full bg-cover bg-no-repeat relative bg-black/20 hover:bg-black/10 duration-400 bg-blend-overlay cursor-pointer rounded-t-lg">
              <div className="absolute top-0 right-0 mr-3 mt-5 flex gap-3 font-Nunito_Sans">
                <span className="bg-C_purple text-white text-[12px] rounded  px-4  py-1 ">
                  Sales
                </span>
        ...
        <div className="flex lg:flex-row flex-col justify-start w-full gap-6 py-5">
          <div className=" bg-white lg:w-1/3 w-full shadow-lg rounded-lg">
            {/* Image  */}
            <figure className="bg-[url(https://i.ibb.co/yc9kXTJS/pexels-pixabay-259580.jpg)] h-[250px] w-full bg-cover bg-no-repeat relative bg-black/20 hover:bg-black/10 duration-400 bg-blend-overlay cursor-pointer rounded-t-lg">
              <div className="absolute top-0 right-0 mr-3 mt-5 flex gap-3 font-Nunito_Sans">
                <span className="bg-C_purple text-white text-[12px] rounded  px-4  py-1 ">
                  Sales
                </span>
          ...
          <div className=" bg-white lg:w-1/3 w-full shadow-lg rounded-lg">
            {/* Image  */}
            <figure className="bg-[url(https://i.ibb.co/tPXY43TJ/pexels-home-decor-interiors-634144-1827054.jpg)] h-[250px] w-full bg-cover bg-no-repeat relative bg-black/20 hover:bg-black/10 duration-400 bg-blend-overlay cursor-pointer rounded-t-lg">
              <div className="absolute top-0 right-0 mr-3 mt-5 flex gap-3 font-Nunito_Sans">
                <span className="bg-C_purple text-white text-[12px] rounded  px-4  py-1 ">
                  Sales
                </span>
          ...
          <div className=" bg-white lg:w-1/3 w-full shadow-lg rounded-lg">
            {/* Image  */}
            <figure className="bg-[url(https://i.ibb.co/fz7Rx2Tb/pexels-pixabay-271624.jpg)] h-[250px] w-full bg-cover bg-no-repeat relative bg-black/20 hover:bg-black/10 duration-400 bg-blend-overlay cursor-pointer rounded-t-lg">
              <div className="absolute top-0 right-0 mr-3 mt-5 flex gap-3 font-Nunito_Sans">
                <span className="bg-C_purple text-white text-[12px] rounded  px-4  py-1 ">
                  Sales
                </span>
